                                        ...
                                        <table cellpadding="0" class="auto-style38">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName" ErrorMessage="Vnesi uporabniško ime." ToolTip="Vpiši uporabniško ime." ValidationGroup="Login2">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" class="auto-style33">
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="PasswordRequired" runat="server" ControlToValidate="Password" ErrorMessage="Vnesi geslo." ToolTip="Vnesi geslo." ValidationGroup="Login2">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
...
">
                                        ...
                                        <table cellpadding="2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="CurrentPasswordRequired" runat="server" ControlToValidate="CurrentPassword" ErrorMessage="Vnesi geslo." ToolTip="Vnesi geslo." ValidationGroup="ChangePassword2">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="NewPasswordRequired" runat="server" ControlToValidate="NewPassword" ErrorMessage="Vnesi novo geslo." ToolTip="Vnesi novo geslo." ValidationGroup="ChangePassword2">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="ConfirmNewPasswordRequired" runat="server" ControlToValidate="ConfirmNewPassword" ErrorMessage="Potrebna je potrditev novega gesla." ToolTip="Potrebna je potrditev novega gesla.." ValidationGroup="ChangePassword2">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" colspan="2">
                                                    <asp:CompareValidator ID="NewPasswordCompare" runat="server" ControlToCompare="NewPassword" ControlToValidate="ConfirmNewPassword" Display="Dynamic" ErrorMessage="Potrditev se mora ujemati z novim geslom." ValidationGroup="ChangePassword2" ForeColor="Red" Font-Size="X-Small"></asp:CompareValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" colspan="2" style="color:Red;">
                    ...
                    <asp:Label ID="lErrCPwd" runat="server" CssClass="auto-style43" Font-Names="Verdana" Font-Size="X-Small" ForeColor="Red" Text="Label" Visible="False"></asp:Label>
                </asp:Panel>
                <br />
